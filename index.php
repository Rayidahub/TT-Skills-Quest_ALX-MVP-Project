    ...
    <div class="hero-header" id="back">
        <div class="wrapper">
            <header>
                ...
                <nav>
                    ...
                    <ul class="navlinks">
                        ...
                        <li><a href="reg.php">Go to App</a></li>
                ...
                <div class="hero-text">
                   ...
                   <br>
                    ...
                    <br>
                        ...
                        <a href="#" class="btn">Let's Build This Together</a>
                    </div>
            ...
            <div class="About-me" >
                ...
                <div class="hero-text">
                    <h5>Hi I'am <span class="input">FullSkack Software Developer</span></h5>
                    <h1 id="sub">Raymond Gaius</h1>
                    <p >Hello, I am a FullStack Software Developer. I have passion for solving-probelm  and enjoy collaborating with others to develop creative solutions. I'm excited about the opportunity to contribute my skills to a team and learn from experienced developers like "You"  in order to grow in my career.</p>
            ...
            <div class="About-me1" id="About-me">
                ...
                <div class="hero-text">
                    ...
                    <p id="text">My inspiration for building a web application to allow users to showcase their skills can stem from various sources and motivations. Here are a few potential inspirations that may resonate with you:
                        ...
                        <a href="http://localhost/chat/chat.php?user_id=1519483108" class="btn">Let's Chat</a>
